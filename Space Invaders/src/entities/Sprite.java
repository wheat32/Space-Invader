...
public class Sprite 
{
	...
	public int drawImage(Graphics2D gfx, Rectangle bounds, int active)
	{
		...
		gfx.drawImage(image, bounds.x, bounds.y, bounds.width, bounds.height, src[curr], 0, sw, image.getHeight(null), null);
		...
		switch(active)
		{
			...
			default:
				...
				{
					bufferBeforeSpriteChange -= deltaTime;
				}
				break;
			case 2:
				if(bufferBeforeSpriteChange <= 0)
